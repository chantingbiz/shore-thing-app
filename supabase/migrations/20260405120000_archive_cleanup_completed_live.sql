-- After copying completed service_logs into service_history, remove only matching live rows
-- (completed service_logs for that date + activity_logs for those properties on that Eastern day).
